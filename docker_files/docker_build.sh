...
docker tag web_s3_db_lambda 120327452865.dkr.ecr.eu-central-1.amazonaws.com/$1:latest
...
aws lambda update-function-code \
      ...
      --image-uri 120327452865.dkr.ecr.eu-central-1.amazonaws.com/web_s3_db_lambda:latest > docker_lambda_update.json